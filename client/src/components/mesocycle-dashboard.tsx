    ...
    <div className="space-y-6">
      ...
      {recommendations && (
        <AnimatedTabs defaultValue="volume" className="w-full">
          <AnimatedTabsList className="flex w-full bg-gray-100 dark:bg-gray-800 p-1 relative rounded-lg shadow-inner">
            <AnimatedTabsTrigger 
              value="volume" 
              className="flex-1 text-xs sm:text-sm px-2 py-2.5 whitespace-nowrap relative z-10 transition-colors duration-200 data-[state=active]:bg-white data-[state=active]:dark:bg-gray-700 data-[state=active]:shadow-md data-[state=active]:text-blue-600 data-[state=active]:dark:text-blue-400 data-[state=active]:font-medium hover:bg-gray-200/70 dark:hover:bg-gray-700/70 data-[state=inactive]:hover:text-gray-700 data-[state=inactive]:dark:hover:text-gray-300 rounded-md"
            >
              <span className="relative z-10">Volume Progression</span>
            </AnimatedTabsTrigger>
            <AnimatedTabsTrigger 
              value="fatigue" 
              className="flex-1 text-xs sm:text-sm px-2 py-2.5 whitespace-nowrap relative z-10 transition-colors duration-200 data-[state=active]:bg-white data-[state=active]:dark:bg-gray-700 data-[state=active]:shadow-md data-[state=active]:text-blue-600 data-[state=active]:dark:text-blue-400 data-[state=active]:font-medium hover:bg-gray-200/70 dark:hover:bg-gray-700/70 data-[state=inactive]:hover:text-gray-700 data-[state=inactive]:dark:hover:text-gray-300 rounded-md"
            >
              <span className="relative z-10">Fatigue Analysis</span>
            </AnimatedTabsTrigger>
            <AnimatedTabsTrigger 
              value="phase" 
              className="flex-1 text-xs sm:text-sm px-2 py-2.5 whitespace-nowrap relative z-10 transition-colors duration-200 data-[state=active]:bg-white data-[state=active]:dark:bg-gray-700 data-[state=active]:shadow-md data-[state=active]:text-blue-600 data-[state=active]:dark:text-blue-400 data-[state=active]:font-medium hover:bg-gray-200/70 dark:hover:bg-gray-700/70 data-[state=inactive]:hover:text-gray-700 data-[state=inactive]:dark:hover:text-gray-300 rounded-md"
            >
              <span className="relative z-10">Phase Management</span>
            </AnimatedTabsTrigger>
          </AnimatedTabsList>

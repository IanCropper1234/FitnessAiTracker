                ...
                <div className={`collapsible-content overflow-hidden transition-all duration-300 ease-in-out ${
                  ...
                  const normalizeToGroupedStructure = (micronutrients: any) => {
                    ...
                    const classifications: { [key: string]: string } = {
                      ...
                      'vitamink1': 'Fat-Soluble Vitamins',
                      'vitamink2': 'Fat-Soluble Vitamins',
                      'vitamink1phyloquinone': 'Fat-Soluble Vitamins',
                      'vitamink2menaquinone': 'Fat-Soluble Vitamins',
                      'vitamink2menaquinone4': 'Fat-Soluble Vitamins',
                      'vitamink2menaquinone7': 'Fat-Soluble Vitamins',
                      'vitaminkspecies': 'Fat-Soluble Vitamins',
                      'phyloquinone': 'Fat-Soluble Vitamins',
                      'menaquinone': 'Fat-Soluble Vitamins',
                      'menaquinone4': 'Fat-Soluble Vitamins',
                      'menaquinone7': 'Fat-Soluble Vitamins',
                      'mk4': 'Fat-Soluble Vitamins',
                      'mk7': 'Fat-Soluble Vitamins',
                      // Vitamin A variants
                      'retinol': 'Fat-Soluble Vitamins',
                      'betacarotene': 'Fat-Soluble Vitamins',
                      'vitaminabetacarotene': 'Fat-Soluble Vitamins',
                      'retinolequivalents': 'Fat-Soluble Vitamins',
                      // Vitamin D variants (D2, D3)
                      'vitamind2': 'Fat-Soluble Vitamins',
                      'vitamind3': 'Fat-Soluble Vitamins',
                      'cholecalciferol': 'Fat-Soluble Vitamins',
                      'ergocalciferol': 'Fat-Soluble Vitamins',
                      'calciferol': 'Fat-Soluble Vitamins',
                      // Vitamin E variants (tocopherols)
                      'alphatocopherol': 'Fat-Soluble Vitamins',
                      'gammatocopherol': 'Fat-Soluble Vitamins',
                      'deltatocopherol': 'Fat-Soluble Vitamins',
                      'tocopherol': 'Fat-Soluble Vitamins',
                      'tocotrienol': 'Fat-Soluble Vitamins',
